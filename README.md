...
### IaC & Terraform
The `terraform` directory has the project's entire IaC setup, which will be explored file by file in this README. This section first will highlight challenges encountered during development, emphasizing the complexity and learning curve associated with IaC.
...
### Terraform Files
Inside each file of terraform you will find a comment over each block of definition, that will allow you to understand what each block does.

#### Pipeline
The lack of a CI/CD pipeline means certain manual steps, here I propose 2 different solutions:
